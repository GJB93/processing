...
void draw()
{
  ...
  if(ballY > (paddleY-ballRadius) && ballY < (paddleY+paddleHeight+ballRadius) && ballX > paddleX-ballRadius && ballX < paddleX+ballRadius+reverse && xSpeed > 0)
  {
    xSpeed = -xSpeed;
    ySpeed = -ySpeed;
  }
  ...
  if(ballY > (paddleY-ballRadius) && ballY < (paddleY+paddleHeight+ballRadius) && ballX > paddleX+paddleWidth-reverse-ballRadius && ballX < paddleX+paddleWidth+ballRadius && xSpeed < 0)
  {
    xSpeed = -xSpeed;
    ySpeed = -ySpeed;
  }
  ...
  if(ballY > (paddleY-ballRadius) && ballY < (paddleY+paddleHeight+ballRadius) && ballX > paddleX-ballRadius && ballX < paddleX+paddleWidth+ballRadius)
  {
